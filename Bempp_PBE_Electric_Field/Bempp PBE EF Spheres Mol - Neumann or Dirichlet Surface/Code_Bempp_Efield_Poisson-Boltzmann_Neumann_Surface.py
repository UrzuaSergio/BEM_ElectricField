...
dlp_Y_12 = modified_helmholtz.double_layer(dirichl_space_2, dirichl_space_2, dirichl_space_1, k)

slp_Y_21 = modified_helmholtz.single_layer(neumann_space_1, dirichl_space_1, dirichl_space_2, k)
dlp_Y_21 = modified_helmholtz.double_layer(dirichl_space_1, dirichl_space_1, dirichl_space_2, k)
...
rhsEf_out_1 = (0.5*identity_11 - dlp_Y_11)*Efield_Pot_grid_fun_1 + slp_Y_12*((sigma02/cte_dielec_ext) + Efield_DerPot_grid_fun_2)
rhsEf_out_2 = - dlp_Y_21*Efield_Pot_grid_fun_1 + slp_Y_21*Efield_DerPot_grid_fun_1 + slp_Y_22*((sigma02/cte_dielec_ext) + Efield_DerPot_grid_fun_2)
...
sol, info, it_count = bempp.api.linalg.gmres(blocked, [charged_grid_fun, rhsEf_out_1, rhsEf_out_2], use_strong_form=True, return_iteration_count=True, tol=1e-5)
