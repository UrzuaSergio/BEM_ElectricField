...
rhsEf_out_2 = -(0.5*identity_22 - dlp_Y_22)*(Phi02_grid_fun) + (0.5*identity_22 - dlp_Y_21)*Efield_Pot_grid_fun_2 - dlp_Y_21*Efield_Pot_grid_fun_1 + slp_Y_21*Efield_Pot_grid_fun_1
